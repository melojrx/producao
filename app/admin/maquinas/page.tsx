...
export default async function AdminMaquinasPage() {
  const [maquinas, tiposMaquina] = await Promise.all([
    listarMaquinas(),
    listarTiposMaquina(),
  ])
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-gray-500">
          Cadastre máquinas, imprima etiquetas QR e altere o status com um clique.
        </p>
      </div>

      <ListaMaquinas maquinasIniciais={maquinas} tiposMaquina={tiposMaquina} />
    </div>
  )
}
