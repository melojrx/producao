...
import { Copy, Eye, FileText, Pencil, Plus, Search } from 'lucide-react'
                      ...
                      <div className="flex flex-col items-end gap-2">
                        <div className="inline-flex items-center gap-1">
                          ...
                          <Link
                            ...
                            aria-label={`Abrir ficha PDF de ${produto.referencia}`}
                            title={`Abrir ficha/PDF de ${produto.referencia}`}
                            className="inline-flex rounded-lg p-1.5 text-gray-400 transition-colors hover:bg-blue-50 hover:text-blue-600"
                          >
                            <FileText size={16} />
                          </Link>
