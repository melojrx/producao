...
export function ModalEditarTurnoAbertoV2({
  ...
  const possuiProducaoPorOp = useMemo(() => mapearPossuiProducaoPorOp(planejamento), [planejamento])
  const setoresAtivos = useMemo(() => mapearSetoresTurnoParaDashboard(planejamento), [planejamento])
  ...
  function handleSalvarNovasOps(): void {
    ...
    iniciarSalvamentoNovasOps(async () => {
      ...
      setMensagemRetorno(
        `${quantidadeSalva} nova(s) OP(s) adicionada(s) ao turno aberto. Os setores já ativos foram reaproveitados e apenas setores inéditos passam a exigir novos QRs operacionais na dashboard.`
      )
    })
  }
      ...
      <div className="max-h-[94vh] w-full max-w-6xl overflow-y-auto rounded-3xl bg-white shadow-2xl">
        ...
        <div className="flex flex-col gap-6 p-6">
          <div className="rounded-2xl border border-blue-200 bg-blue-50 px-4 py-3 text-sm text-blue-900">
            O turno continua aberto durante esta edição. Novas OPs entram no planejamento atual,
            reaproveitam os setores já ativos e só criam novos QRs quando o novo produto exigir um
            setor ainda inexistente no turno.
          </div>
          ...
          <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
            <div className="space-y-2">
              <h3 className="text-base font-semibold text-slate-900">Setores ativos do turno</h3>
              <p className="text-sm text-slate-600">
                Esta é a estrutura física já aberta para o dia. Quando novas OPs entrarem no turno,
                elas serão distribuídas dentro desses setores sempre que houver coincidência de
                roteiro.
              </p>
            </div>
            ...
            <div className="mt-4 grid gap-3 lg:grid-cols-2">
              {setoresAtivos.length === 0 ? (
                <div className="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-600">
                  Nenhum setor ativo foi derivado para este turno até o momento.
                </div>
              ) : (
                        ...
                        <div className="rounded-2xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-900">
                          <div className="flex items-start gap-2">
                            ...
                            <div>
                              ...
                              <p>
                                Esta OP já possui produção apontada em pelo menos um setor do turno.
                                Produto, quantidade planejada e número da OP não podem mais ser
                                alterados.
                              </p>
                            </div>
                          </div>
          ...
          <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
            <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
              <div>
                ...
                <p className="text-sm text-slate-600">
                  ...
                  inclusão alimenta os setores já ativos sempre que houver coincidência de roteiro.
                  Apenas setores inéditos passam a gerar novos QRs operacionais.
                </p>
              </div>
            ...
            <div className="mt-5 rounded-2xl border border-cyan-200 bg-cyan-50 px-4 py-3 text-sm text-cyan-900">
              ...
              para {totalPlanejadoAtual + totalPlanejadoNovasOps} unidades planejadas. Os setores já
              ativos continuarão sendo reaproveitados e somente setores ainda inexistentes no turno
              exigirão novo QR operacional.
            </div>
          </section>
